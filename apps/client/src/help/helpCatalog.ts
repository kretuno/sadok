...
export const helpArticles: HelpCatalogArticle[] = [
  ...
  { id: 'reports-communication', number: '09', title: 'Звіти та сповіщення', description: 'Формування звітів, експорт і контроль важливих подій.', keywords: ['звіт', 'друк', 'експорт', 'сповіщення'], content: reportsCommunication },
